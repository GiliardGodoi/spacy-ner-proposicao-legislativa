...
![Screen demonstration](imgs/screen-map.png)

This repo implements a Named Entity Recognition example using with spaCy.

This work was presented at '14º Encontro de Tecnologia da Comunidade GITEC' organized by the Interlegis Work Group. The slides can be in this repository.
